...
public class PlayerCamera : MonoBehaviour
{
    ...
    private void RotateCamera()
    {
        ...
        lookAmountHorizontal = Mathf.Clamp(lookAmountHorizontal, minimumPivotAngel, maximumPivotAngle); //lock values between min + max
        ...
        targetRotation = Quaternion.Euler(cameraRotation);
        targetRotation = Quaternion.Slerp(cameraPivot.localRotation, targetRotation, cameraSmoothTime); //chang up/down via pivot rotation, left/right via game obj rotation
